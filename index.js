 ...
 */
exports.datasetCollector = async function (url, key, name, useServerTime) {
  try {
    ...
    if (useServerTime) {
      return (timeSeriesName, datapoint) =>
        addDataPoint(timeSeriesName, datapoint, undefined);
    } else {
      return (timeSeriesName, datapoint, time) =>
        addDataPoint(timeSeriesName, datapoint, time);
    }
  } catch (e) {
    return { error: e };
  }
